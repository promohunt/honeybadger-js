...
var bsLocalStopped = false;
var stopBsLocal = function () {
    return new Promise(function (resolve) {
        if (bsLocalStopped) {
            return resolve();
        }
        if (browserstack_config_1.bsLocal && browserstack_config_1.bsLocal.isRunning()) {
            browserstack_config_1.bsLocal.stop(function () {
                bsLocalStopped = true;
...
module.exports = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, stopBsLocal()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
