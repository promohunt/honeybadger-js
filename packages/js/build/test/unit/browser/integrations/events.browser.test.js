...
var events_1 = __importDefault(require("../../../../src/browser/integrations/events"));
var consoleMocked = function () {
    return {
...
describe('window.console integration for events logging', function () {
    var client, mockLogEvent, mockConsole;
    beforeEach(function () {
        jest.clearAllMocks();
    ...
    it('should skip install by default', function () {
        var window = { console: mockConsole };
        (0, events_1.default)(window).load(client);
    ...
    it('should send events to Honeybadger', function () {
...
//# sourceMappingURL=events.browser.test.js.map