...
var util_1 = require("../../../src/server/util");
var getSourceForBacktrace = core_1.Util.getSourceForBacktrace, makeBacktrace = core_1.Util.makeBacktrace, makeNotice = core_1.Util.makeNotice;
...
describe('getSourceForBacktrace', function () {
    it('returns a parsed stacktrace in Honeybadger format', function notAnonymous() {
        return __awaiter(this, void 0, void 0, function () {
            var error, notice, backtrace;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        error = new Error('this is an error from tests');
                        notice = makeNotice(error);
                        ...
                        return [4 /*yield*/, getSourceForBacktrace(notice.backtrace, util_1.getSourceFile)];
                    case 1:
                        backtrace = _a.sent();
...
//# sourceMappingURL=backtrace.server.test.js.map